...
import softhealth.zombiecatch.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "zombiecatch.softhealth", ownerName = "zombiecatch.softhealth", packagePath = ""))
